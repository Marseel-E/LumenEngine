...
public:
	...
	/**
	 * Access raw pointee.
	 * @warning Avoid wrapping the returned value again, as it may lead double frees unless this object becomes
	 * detached.
	 */
	_Class* get() const;
...
template <class _Class>
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(SharedPtr<_Class>&& other) noexcept : m_pObject(other.m_pObject) {
...
template <class _OtherClass>
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(
	SharedPtr<_OtherClass>&& other, typename std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>>*) noexcept
...
template <class _Class>
template <class _OtherClass>
typename std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>, NS::SharedPtr<_Class>&> _NS_INLINE
NS::SharedPtr<_Class>::operator=(const SharedPtr<_OtherClass>& other) __attribute__((no_sanitize("undefined"))) {
	_Class* pOldObject = m_pObject;
...
template <class _OtherClass>
typename std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>, NS::SharedPtr<_Class>&> _NS_INLINE
NS::SharedPtr<_Class>::operator=(SharedPtr<_OtherClass>&& other) __attribute__((no_sanitize("undefined"))) {
